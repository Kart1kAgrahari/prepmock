...
Please provide exactly ${noOfQuestions} interview questions with answers in the following JSON format:
{
  "questions": [
    {
...
Do not include any additional text, markdown formatting, or explanation before or after the JSON.`;
  ...
  return (
    <div>
      ...
      >
        <h2 className="font-bold text-lg text-black dark:text-white">+ Generate Mock Interview</h2>
      </div>
      ...
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        <DialogContent className="max-w-2xl bg-white dark:bg-gray-900 text-black dark:text-white shadow-lg rounded-lg">
          <DialogHeader>
            <DialogTitle className="text-2xl font-semibold">Tell us about your job interview</DialogTitle>
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              {/* no of questions you want */}
              <div className="space-y-2">
                <label className="text-sm font-bold">Number of questions you want to answer</label>
                <Input
                  className="bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 focus:ring-primary focus:border-primary text-black dark:text-white"
                  placeholder="Ex. 1"
                  type="number"
